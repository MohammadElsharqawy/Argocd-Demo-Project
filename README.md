...
```bash
git clone https://github.com/MohammadElsharqawy/Argocd-Demo-Project.git
cd Weather-App
```
...
````bash
docker pull sharqm/weather-app:latest
````
**3.** **Run Docker Container**
````bash
docker run -p 5000:8080 --name appcontainer sharqm/weather-app:latest
````
